package com.uebung.maus.getingstarted.pogba.mydemou01.ChatApp;
...
import com.uebung.maus.getingstarted.pogba.mydemou01.R;
...
public abstract class AbstractMessageSender extends Activity {
    ...
    protected void updateConversation(String message) {
        ...
        TextView conversation = findViewById(R.layout.conversation_transcript);
        conversation.append("\n" + message);
    }
