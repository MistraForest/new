...
public abstract class AbstractMessageSender extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Das Eingabefeld f�r eine neue Nachricht
	...
	/**
	 * Unterklassen k�nnen die Ansicht ausw�hlen. Diese muss lediglich zumindest
	 ...
	 * Nachrichten werden in neuer Zeile angeh�ngt
	 */
	...
	/**
	 * Bsp. f�r Pattern "Abstract Method"
	 * 
	 * �bernimmt Verarbeitung einer Nachricht, die im Eingabefeld der App eingetippt wurde
	 * 
	 * @param message
	 */
