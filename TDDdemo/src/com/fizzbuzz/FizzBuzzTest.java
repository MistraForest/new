...
class FizzBuzzTest {
    ...
    @Test
    public void shouldReturn12IfPassNumber1To2(){
        assertEquals("12",fizzBuzz.generate(1,2));
    }

    @Test
    public void shouldReturn12FizzIfPassNumber1To3(){
        assertEquals("12Fizz",fizzBuzz.generate(1,3));
    }

    @Test
    public void shouldReturn12Fizz4BuzzIfPassNumber1To5(){
        assertEquals("12Fizz4Buzz",fizzBuzz.generate(1,5));
    }

    @Test
    public void shouldReturn12Fizz4BuzzFizz78FizzBuzz11Fizz1314FizzBuzzIfPassNumber1To15(){
